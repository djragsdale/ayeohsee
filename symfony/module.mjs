export function ContainerReference(containerName) {
  this.containerName = containerName;
}

export function SymfonyContainer(containerBuilder, className, classProto) {
...
export function ContainerBuilder(classes) {
